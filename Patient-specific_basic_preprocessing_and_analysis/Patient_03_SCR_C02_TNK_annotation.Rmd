---
title: "Patient_03_SCR_C02_TNK_annotation"
...
data.tnk$sample[data.tnk$sample_id == "SPE_1_03_C02_A_FRESH_C45"] <- "C02"
data.tnk$sample[data.tnk$sample_id == "SPE_1_03_SCR_A_FRESH"] <- "SCR"
```
...
```{r}
# annotation
annotation <- c(      "CD4+ T Central Memory",            #0 
                      "CD8+ T Effector Memory",           #1 effector-like
                      "CD8+ Trm Exhausted",               #2 Trm too!
                      "CD8+ T Effector Memory",           #3 (Temra)
                      "CD4+ T Regulatory",                #4
                      "NOISE",                            #5
                      "Cycling T",                        #6 ? CM, GINS2, ti meless, many cell cycle genes
                      "NKT",                              #7  NK markers and TCR markers
                      "CD4+ T Naïve",                     #8 tissue resident too
                      "CD4+ T Helper",                    #9   IL2, IFNG, LTA 
                      "CD56bright CD16hi NK",             #10  
                      "T Proliferative",                  #11 
                      "MAIT",                             #12 

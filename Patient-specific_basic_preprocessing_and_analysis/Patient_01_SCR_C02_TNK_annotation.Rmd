...
data.m$sample[data.m$sample_id == "SPE_1_01_C2D1_A_FRESH_1"] <- "C02.1"
data.m$sample[data.m$sample_id == "SPE_1_01_C2D1_A_FRESH_2"] <- "C02.2"
data.m$sample[data.m$sample_id == "SPE_1_01_SCR_A_FRESH"] <- "SCR.1"
data.m$sample[data.m$sample_id == "SPE_1_01_SCR_A_FRESH_CD45"] <- "SCR.2.CD45"
```
...
```{r}
# annotation
annotation <- c(      "CD8+ T Effector",              #0 Temra
                      "CD8+ Trm Exhausted",           #1 tissue resident
                      "CD4+ T Central Memory",        #2 Central memory
                      "CD4+ T Helper",                #3 
                      "CD4+ T Regulatory",            #4
                      "CD4+ T Follicular Helper",     #5
                      "NOISE",                        #6
                      "NKT",                          #7 NKT effector |  CD8+ T effector
                      "CD56bright CD16dim NK",        #8
                      "CD56bright CD16hi NK",         #9   
                      "Gamma-delta T",                #10  
                      "T Proliferative",              #11 
                      "NKT",                          #12 doublets? 
                      "MAIT",                         #13
                      "IFN T Responding",             #14
                      "NOISE"                         #15 T progenitor? pdcs myeloid check cd3

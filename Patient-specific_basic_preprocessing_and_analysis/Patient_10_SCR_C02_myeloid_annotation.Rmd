---
title: "Patient_10_SCR_C02_myeloid_annotation"
...
data.m$sample[data.m$sample_id == "SPE_1_10_SCR_A_FRESH_CD45neg"] <- "SCR.CD45-"
data.m$sample[data.m$sample_id == "SPE_1_10_SCR_A_FRESH_CD45pos"] <- "SCR.CD45+"
data.m$sample[data.m$sample_id == "SPE_1_10_C2_A_FRESH_CD45neg"] <- "C02.CD45-"
data.m$sample[data.m$sample_id == "SPE_1_10_C2_A_FRESH_CD45pos"] <- "C02.CD45+"
```
...
```{r}
annotation <-c("CD14+ CD16- Mono",       #0 
               "NOISE",                  #1 T cell doublets
               "CD14- CD16+ Mono",       #2 
               "Angio TAM",              #3 
               "CD14+ CD16- Mono",       #4 
               "Inflam TAM",             #5
               "cDC1",                   #6 #check subclustering
               "TRM Kupffer-like TAM",   #7
               "pDC",                    #8
               "LA TAM",                 #9 
               "NOISE",                  #10 T high
               "cDC1"                    #11 

---
title: "Patient_01_SCR_C02_myeloid_annotation"
...
anno <- DimPlot_scCustom(data, 
                         ...
                         label = F, 
                         colors_use = c("red", "blue", "darkorange","darkgreen",  "green", "skyblue", "gold"),
                         figure_plot = T) 
anno
```
...
annotation <-c("CD14+ CD16- Mono",         #0 
               ...
               "LA TAM",                   #4
               "Angio TAM",                #5
               "NOISE",                    #6 T cell doublets
               "Anti Inflam TAM",          #7
               "cDC2",                     #8
               "pDC",                      #9 
               "NOISE",                    #10 MT high
               "IFN TAM",                  #11 
               "Anti Inflam TAM",          #12 maybe NOISE? high mt and doublet score
               "MAST",                     #13 
               "NOISE"                     #14 
)

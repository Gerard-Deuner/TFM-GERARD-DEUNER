---
title: "Patient_01_Tumor-Blood_TCR_Analysis"
author: "Gerard Deuner Cos"
date: "2024-05-07"
output: html_document
---

# Patient 01 Tumor & Tumor-Blood Matching TCR Preprocessing & Analysis
...
```{r}
# read TNK, annotated and clean patient 01 seurat object
#data <- qread("/Users/gerarddeunercos/Documents/cluster1/gdeuner/SERPENTINE/data/outputdata/Patient_01/Patient_01_SCR_CO2_TNK_subset_pp_annotated_clean_30-01-24")
data <- qread("/Users/gerarddeunercos/Documents/SERPENTINE/data/outputdata/Patient_01_SCR_CO2_TNK_subset_pp_annotated_clean_30-01-24")
```
...
#data <- subset(data, subset = !(Annotation_2.0 %in% c("γδ T-like", "Cycling γδ T-like", "CD56dim CD16hi NK", "CD56hi CD16lo NK", "NA")))
...
contig_list_TCR <- list(P01_S1, P01_S2, P01_S3, P01_S4)
...
combined_tcr <- combineTCR(contig_list_TCR, 
                ID = c( 
                  "01_CD45", "01_total", "SPE_1_01_C2D1_A_FRESH_1", "SPE_1_01_C2D1_A_FRESH_2"
                  ), 
                samples = c(
                  "SERPENTINE_04_05", "SERPENTINE_04_05", "SERPENTINE_08_09", "SERPENTINE_08_09"
                  )
                )
...
data$blood_pre <- ifelse(data$CTnt_TRB %in% p01_pre_blood_tcr$cdr3_nt, T, F)
data$blood_post <- ifelse(data$CTnt_TRB %in% p01_post_blood_tcr$cdr3_nt, T, F)
...
write.csv(p01.pre %>% distinct(), file = "/Users/gerarddeunercos/Documents/cluster1/gdeuner/SERPENTINE/data/TCR_tumor_blood_analysis/Patient_01/files/SPE01_tumour_overlap_blood_pre_phenotype.csv")

# post
p01.post <- data@meta.data %>%
  select("CTnt", "CTnt_TRB", "cell_type", "Annotation_2.0", "blood_post") %>%
  filter(blood_post == T) %>%
  select("CTnt_TRB", "cell_type", "Annotation_2.0") %>%
  dplyr::rename(CTnt = CTnt_TRB, CellType_1_0 = cell_type, CellType_2_0 = Annotation_2.0)
write.csv(p01.post %>% distinct(), file = "/Users/gerarddeunercos/Documents/cluster1/gdeuner/SERPENTINE/data/TCR_tumor_blood_analysis/Patient_01/files/SPE01_tumour_overlap_blood_post_phenotype.csv")
``` 
...
tcr.overlap <- read.csv("/Users/gerarddeunercos/Documents/cluster1/gdeuner/SERPENTINE/data/differential_expansion_overlap_tumour/SPE01_tumour_blood_differential_overlap.csv")
```
...
write.csv(p01.diffExp %>% distinct(), file = "/Users/gerarddeunercos/Documents/cluster1/gdeuner/SERPENTINE/data/TCR_tumor_blood_analysis/Patient_01/files/SPE01_tumour_blood_differential_overlap_phenotype.csv")
```

```{r}
# quality control
p01.diffExp$CTnt %>% length()
p01.diffExp$CTnt %>% unique() %>% length()
intersect(p01.diffExp$CTnt, tcr.overlap$cdr3_nt) %>% length()
```
...
qsave(data, "/Users/gerarddeunercos/Downloads/P01_TNK_TCR_updated_07-05-24.qs")
```
...
SaveH5Seurat(data, filename = "/Users/gerarddeunercos/Downloads/P01_TNK_TCR_updated_07-05-24", dest = "h5seurat", overwrite = T)
Convert(file.path("/Users/gerarddeunercos/Downloads/P01_TNK_TCR_updated_07-05-24.h5seurat"), dest = "h5ad", overwrite = T)
```

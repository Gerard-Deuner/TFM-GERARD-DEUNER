---
title: "Patient_08_SCR_C02_overview"
...
```{r}
data$timepoint <- recode(data$sample,
                       "SPE_1_08_SCR_A_FRESH" = "SCR",
                       "SPE_1_8_C2_A_FRESH_1" = "C02",
                       "SPE_1_8_C2_A_FRESH_2" = "C02")
data$timepoint <- factor(data$timepoint, levels = c("SCR", "C02"))
data$patient <- "P08"
```
...
umap <- DimPlot(data, group.by = "cluster_res1.5", label = T)
umap
```
...
data <- qread(file = paste0(data.dir, "tmpdata/", patient, "_SCR_CO2_harmony_integrated_pp_22-01-24"))
```
...
```{r}
# read markers
markers <- read.csv(file = paste0(data.dir, "markers/", patient, "/", patient, "_res1.5_markers.csv"))
```
...
fplots.1 <- lapply(1:length(markers.1), function(x){
  ...
  FeaturePlot(object = data, features = feature) +
...
anno <- DimPlot(data, group.by = "Annotation_1.0", label = F) + 
  scale_color_manual(values = c("red", "#333333", "darkorange", "blue", "darkgreen", "gold", "#996633", "green", "skyblue", "grey", "violet")) + 
...
```{r eval = FALSE}
S1 <- read.csv(paste0(proj.dir, "data/SERPENTINE_22_23/jobs/SPE_1_08_SCR_A_FRESH/SPE_1_08_SCR_A_FRESH/outs/per_sample_outs/SPE_1_08_SCR_A_FRESH/vdj_t/filtered_contig_annotations.csv"))
S2 <- read.csv(paste0(proj.dir,"data/SERPENTINE_30_31/jobs/SPE_1_8_C2_A_FRESH_1/SPE_1_8_C2_A_FRESH_1/outs/per_sample_outs/SPE_1_8_C2_A_FRESH_1/vdj_t/filtered_contig_annotations.csv"))
S4 <- read.csv(paste0(proj.dir,"data/SERPENTINE_30_31/jobs/SPE_1_8_C2_A_FRESH_2/SPE_1_8_C2_A_FRESH_2/outs/per_sample_outs/SPE_1_8_C2_A_FRESH_2/vdj_t/filtered_contig_annotations.csv"))

contig_list_TCR <- list(S1, S2, S4)

# TCR
combined_tcr <- combineTCR(contig_list_TCR, 
                ID = c("SPE_1_08_SCR_A_FRESH", "SPE_1_8_C2_A_FRESH_1", "SPE_1_8_C2_A_FRESH_2"), 
                samples = c("SERPENTINE_22_23", "SERPENTINE_30_31", "SERPENTINE_30_31")
                )
